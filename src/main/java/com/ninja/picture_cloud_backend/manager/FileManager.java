package com.ninja.picture_cloud_backend.manager;
...
import com.ninja.picture_cloud_backend.config.CosClientConfig;
...
public class FileManager {
    ...
    public UploadPictureResult uploadPicture(MultipartFile multipartFile, String uploadPathPrefix) {
        ...
        //自己拼接上传路径，而不是使用原始文件名称，可以增强安全性
        String uploadFilename = String.format("%s_%s.%s", DateUtil.formatDate(new Date()), uuid, FileUtil.getSuffix(originalFilename));
        String projectName = "picture_cloud";
    ...
    private void validPicture(MultipartFile multipartFile) {
        ...
        //允许上传的文件后缀列表
        final List<String> ALLOW_FORMAT_LIST = Arrays.asList("jpeg", "png", "jpg","webp","bmp","gif","svg");
